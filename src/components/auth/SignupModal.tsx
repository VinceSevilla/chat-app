      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            disabled={loading || success}
            className="mt-4 w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
          >
